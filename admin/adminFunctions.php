<?php
    ...
    class AdminFunctions{
        ...
        function getMaterial($matId){
            ...
            $getMatQuery = "select * from material where mat_id = '$matId'";
            $getMat = $this->getConnection()->query($getMatQuery);
            return $getMat[0];

        }
        function updateMaterial($matId, $matTitle){

            $updateQuery = "update material set mat_title = '$matTitle' where mat_id = '$matId'";
            $this->getConnection()->query($updateQuery);
            header("Location: view_all_materials.php");
        }
