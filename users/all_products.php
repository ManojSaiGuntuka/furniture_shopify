...
<html lang="en">
   <head>
      <meta charset="UTF-8">
      <title>ClickRippleAPP Furniture</title>
               ...
               <div class="row">
                  <div class="col-md-4 col-sm-12 left-rs">
                     <div class="navbar-header">
                        ...
                        <a href="user_index.php" class="navbar-brand"><img src="images/clickripple.png" alt="" style="width: 65%" /></a>
            ...
            <div class="modal-content">
               ...
               <div class="modal-body">
                  <ul>
                     ...
                     <li><a href="#"><img src="images/flag-up-2.png" alt="" /> Canada </a></li>
                  </ul>
               </div>
            </div>
         </div>
            ...
            <div class="container">
               <div class="row">
                  <ol class="breadcrumb">
                     ...
                     <li class="active">Furniture Products</li>
                  </ol>
               </div>
            </div>
         </div>
            ...
            <div class="row">
               <div class="furniture-main">
                           ...
                           <div class="panel-group" id="accordion">
                              <div class="panel panel-default">
                                 ...
                                 <div id="collapse1" class="panel-collapse collapse">
                                   <div class="panel-body"><a href="all_products.php?sortby=pri" class="btn btn-sm btn-info m-1" style="width:40%"> <b>PRICE</b></a></div>
                                 </div>
                              </div>
                              <div class="panel panel-default">
                                 <div class="panel-heading">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        require_once("../inc/connect.php");
                                            $query3 = "SELECT * FROM material";
                                             ...
                                             $select_all_material_query = mysqli_query($conn, $query3);
            			                            while($row3= mysqli_fetch_assoc($select_all_material_query)){     					                           
                                        ?>
                                               
                                             <a href="all_products.php?sortby=<?php echo $row3['mat_id']?>" class="btn btn-sm btn-info m-1" style="width:50%; margin: 10px 10px 10px 10px;" > <b><?php echo $row3['mat_title']?></b> <br></a>
                                       <br/>
                                        <?php
                  ...
                  <div class="col-md-6 col-sm-8">
                     <div class="furniture-middle" style="display:inline">
                                                    ...
                                                    if(!empty($_GET["cid"])){
                                                     ...
                                                     $query = "SELECT * FROM products where categoryID = $cid ";
                                                       ...
                                                       if ($sortby === "pri") {
                                                        ...
                                                        $query = "SELECT * from products having  mat_id = $sortby";
                                                       }
                                                       else if($sortby === "2"){
                                                        $query = "SELECT * from products having  mat_id = $sortby";
                                                       }
                              ...
                              <div class="col-md-6">
                                 <div class="right-big-b">
                                    <div class="tight-btn-b clearfix">
                                       <a class="view-btn" href="product_detail.php?pid=<?php echo $row1['productId']?>">View</a>
                                       <a href="#" tabindex="0"> Price : <?php echo $row1['productPrice'] ?></a>
                                    </div>
                     ...
                     <div class="furniture-right">
                        ...
                        <div class="right-list-f">
                            <?php
                             ...
                             ?>
                                 <ul>
                                     <li><a href="all_products.php?cid=<?php echo $row['cat_id']?>"><img width="32" src="images/product/<?php echo $row["cat_image"] ?>" alt="#" /> <?php echo $row['cat_title'] ?></a></li>
