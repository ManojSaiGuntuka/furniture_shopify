   ...
   $collections = $collectionsPhp['custom_collections'];
    ...
    if(isset($_POST['import_to_store'])){
       ...
       $UF = new UserFunctions();
        ...
        if(isset($_POST['productImages'])){ $productImages = $_POST['productImages']; }else{ $productImages = ""; }
         $watchListId = $_POST['import_to_store'];
         $productColor = $_POST['productColor'];
         $profit = $_POST['profit_input'];
         $stock = $_POST['stock'];
         $cur_pro_id = $_POST['item_id'];
         if(isset($_POST['collection'])){$collectionId = $_POST['collection'];}else{$collectionId = [];}

         $add_tags = $_POST['add_tags'];

        // Get the image and convert into string
        $img = file_get_contents('images/'.$productImage);
        $encodedImage = base64_encode($img);  // Encode the image string data into base64

        $addedToStore = $UF->addToStore($product_name, $desc, $productImage, $encodedImage, $productImages, $productColor, $newPrice, $watchListId, $cur_pro_id, $profit, $stock, $collectionId,$add_tags);
                                                            ...
                                                            <div>
                                                               <div class="multiselect" tabindex="-1" max-height="600">
                                                                  ...
                                                                  <div class="multiselect_tags">
                                                                     ...
                                                                     Choose Collection
                                                                     <select class="multiselect_placeholder chosen-select" data-placeholder="" name="collection[]" multiple><!-- onclick="displayProductsBodyContainer()"-->
                                                             ...
                                                             <div>
                                                                 <div class="multiselect" tabindex="-1" max-height="600">
                                                                     <div class="multiselect_select"></div>
                                                                     <div class="multiselect_tags" style="margin-top:3%;">
                                                                         <div class="multiselect_tags-wrap">
                                                                             <div id="ajaxCollections" class="input-block multiselect_input" name="" autocomplete="off" placeholder="Choose collection" tabindex="0"
                                                                                  style="position: absolute; z-index: -1; padding: 0px;">
                                                                                 <div class="input-field input-field-no-value" name="" autocomplete="off" placeholder="Choose collections" tabindex="0">
                                                                         ...
                                                                         Insert tags here
                                                                         <input type="text" class="form-control" name="add_tags" placeholder="beds,furniture,homedecor,interiordesign,chairs" style="border:1px solid #8e8eb0;border-radius: 3px;color:#272742;"/>
                                                                     </div>
                                                                 </div>
                                                             </div>
                                                         ...
                                                         <ul class="image-selector_draggable">
                                                            <li class="image-selector_thumbnail">
                                                               <div class="product-image product-image-is-selected">
                                                                  ...
                                                                  <div class="product-image_overlay">
                                                                   ...
                                                                   <?php $productId = $watchListData[$index]['productId'];
                                                                   $productData = $UF->getProduct($productId);
                                                                   //var_dump($productData[0]['productImages']);
                                                                   ?>
                                                                  <img class="product-image_img" src="images/<?php echo $productData[0]['productImage']; ?>">
                                                               </div>
                                                            </li>
                                                             <?php
                                                             $images = array();
                                                             //while($result=mysqli_fetch_array($sql1)){
                                                                 ...
                                                                 $images = unserialize($productData[0]['productImages']);
                                                                 if(is_array($images) || is_object($images)){
                                                                     //echo "<input type='hidden' name='productImages' value='";print_r($images); echo "' />";
                                                                     echo "<input type='hidden' name='productImages' value='".$productData[0]['productImages']."' />";
                                                            ...
                                                            <li class="image-selector_thumbnail">
                                                               <div class="product-image product-image-is-selected">
                                                                  ...
                                                                  <img class="product-image_img" src="images/<?php echo $image; ?>" style="height:100%; width: :100%;">
                                                               </div>
                                                            </li>
                                                             <?php
...
<!--                                                            </li>-->
          ...
          <script>
              ...
              function displayProductsBodyContainer(){
                  console.log("abc");
                  //document.getElementsByClassName("tabs-1").show();
              }
          </script>
      <script>
         $(document).ready(()=>{
